...
const CRYPTO_PROMPT = [
  ...
  "4. Near-resolution arb: |gap| > 2× volatility AND timeRemaining < 90s AND market odds ≥ 50% in the gap direction → HIGH confidence",
  "   (If UP gap, upPrice must be ≥ 0.50. If DOWN gap, downPrice must be ≥ 0.50. Otherwise the market already prices in the reversal — SKIP.)",
