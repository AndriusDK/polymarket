...
const CRYPTO_PROMPT = [
  ...
  "     ⚠ FADE signal is ALWAYS the OPPOSITE of the crowd leader.",
  "       If crowd leader = UP  → FADE always means BUY_DOWN (you are fading the crowd).",
  "       If crowd leader = DOWN → FADE always means BUY_UP  (you are fading the crowd).",
  "       If you find yourself BUY_UP when crowd leader = UP, that is CONFIRM, NOT FADE.",
  "     ⚠ FADE requires BOTH conditions to be true simultaneously:",
  "       1. effective gap direction OPPOSES the crowd leader (negative gap when crowd = UP, or positive when crowd = DOWN)",
  "       2. candle trend strongly agrees with fade direction (4+/5 candles in fade direction)",
  "       If only ONE of these contradicts, use CONFIRM or SKIP instead — do not FADE.",
